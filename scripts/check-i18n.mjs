...
const requiredRuntimeKeys = [
  ...
  "errors.audio.com_initialization_failed",
  "errors.audio.device_in_use",
  "errors.audio.device_unavailable",
  "errors.audio.diagnostic_detail",
  "errors.audio.permission_denied",
  "errors.audio.process_loopback_unavailable",
  "errors.audio.service_not_running",
  "errors.audio.start_task_failed",
  "errors.audio.start_thread_failed",
  "errors.audio.start_timeout",
  "errors.audio.unavailable",
  "errors.audio.unsupported_format",
